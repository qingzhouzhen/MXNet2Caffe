...
parser.add_argument('--mx-json',     type=str, default='model_mxnet/ped_light_classify-symbol.json')
parser.add_argument('--cf-prototxt', type=str, default='model_caffe/ped_light_classify.prototxt')
